...
def main():
	parser = argparse.ArgumentParser(description="Script to calibrate a regular lens from different sources.")
	parser.add_argument("--source", choices=['analog', 'dji', 'openipc'], help="Camera source to use", required=True)
